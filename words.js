...
function processText(text) {
    ...
    if (selectedRow > 6 && text != wordOfTheDay) {
        ...
        document
            ...
            .setAttribute("value", "The word was " + wordOfTheDay);
...
function colorKeyboard(colorsByKeyCode) {
    for (var i = 0; i < colorsByKeyCode.length; i++) {
        ...
        key = document
            .getElementById("a-keyboard-" + colorsByKeyCode[i].letter)
            .parentElement.querySelectorAll("a-entity");
...
function updateInput(e) {
    ...
    switch (code) {
        ...
        case 06:
            ...
            if (WORDS.includes(input)) {
                ...
                document
                    .querySelector("#input")
                    .setAttribute("text-geometry", "Not in word list");
    ...
    document
        .querySelector("#input")
        .setAttribute("material", "color:gold; metalness:0.9; emissive:1;");

    document
        .querySelector("#input")
        .setAttribute("text-geometry", "value", input);
}
/* Here is the explanation for the code above:
